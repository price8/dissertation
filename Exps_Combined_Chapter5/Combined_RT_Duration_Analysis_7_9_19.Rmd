...
```{r}
load("/Users/morganprice/dissertation/Exps_Combined_Chapter5/Exp2_CLEAN_RT_Dataframe_8_04_19.RData")
...
load("/Users/morganprice/dissertation/Exps_Combined_Chapter5/Driver_Reaction_Dataframe_Exp1_7_29_19.RData")
reaction.exp1 = select(reaction, pid, algorithm, responsibility, experiment, adj.time, auto.mode, traffic.demand, f.traffic.demand, eyes.on.road.m, driver.reaction.time, reaction.duration, speed, hazard, relevant.hazard)

reaction.exp1 = reaction.exp1 %>% ungroup() %>% group_by (pid, algorithm, responsibility)%>%
   mutate(pid.adj = pid + 0.1)

#LOAD DATA FROM EXPERIMENT 2 & RENAME
load("/Users/morganprice/dissertation/Exps_Combined_Chapter5/Driver_Reaction_Dataframe_Exp2_8_4_19.RData")

reaction.exp2 = select(reaction.exp2, pid, algorithm, responsibility, experiment, adj.time, auto.mode, traffic.demand, f.traffic.demand, eyes.on.road.m, driver.reaction.time, reaction.duration, speed, hazard, relevant.hazard)
...
reaction.df = filter(reaction.df, driver.reaction.time!=-1)
...
reaction.time.violin.plot = ggplot() + 
  ...
  geom_pointrange(data=reaction.summary, mapping=aes(x=algorithm, y=reaction.time.m, ymin=min.reaction.time,
...
```{r}
################## STATISTICAL MODELS FOR AUTOMATION USE AND EOR IN LATENT HAZARD ZONES ###################
#Run statistical model of DV ~ algorithm + responsibility + traffic.demand + (1|pid) + (1|relevant.hazard)
