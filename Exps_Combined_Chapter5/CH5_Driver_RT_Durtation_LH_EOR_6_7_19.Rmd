...
# load("/Users/morganprice/Documents/Dissertation/Analysis/Exp1_Chapter3/CC_Toyota_CLEAN_3_03_17.RData") 
##Select variables of interest from the dataset & ONLY INCLUDE participants in ADAPTIVE CONDITION- EXPERIMENT 1 
# data.exp1 = filter(data.demand, algorithm == "adapt")
# 
# #Select variables of interest from the dataset - EXPERIMENT 2 
# data.exp1 = data.exp1 %>% ungroup() %>% 
#   select(window.time.1, pid, algorithm, responsibility, relevant.hazard, hazard, driver.position.1, auto.mode,
#           eyes.on.road.m, lane.deviation.2, logstreams.1, mili.wallclock, wallclock, speed, traffic.present.all,
#          distance.traffic.m, traffic.demand)
